...
urlpatterns = [
    ...
    path('user-shopping', views.UserShopping.as_view(), name='user_shopping_page'),
    path('user-shopping-detail/<order_id>', views.my_shopping_detail ,name='user_shopping_detail_page'),
