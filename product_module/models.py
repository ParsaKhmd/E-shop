...
class ProductBrand(models.Model):
    ...
    url_title = models.CharField(max_length=200, verbose_name='نام برند در url', db_index=True)
...
class ProductTag(models.Model):
    caption = models.CharField(max_length=200, verbose_name="تگ", db_index=True)
